import {CART_ADD_ITEM,CART_REMOVE_ITEM,CART_SAVE_SHIPPING_ADDRESS,CART_SAVE_PAYMENT_METHDD} from "../constants/cartConstants";
    ...
    switch(action.type){
        case CART_ADD_ITEM:
            ...
            case CART_SAVE_SHIPPING_ADDRESS:
                ...
                case CART_SAVE_PAYMENT_METHDD: return{...state,paymentMethod:action.payload}
